...
import { ArrowLeft, BarChart3, Construction, DollarSign, TrendingUp, Users } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <Card className="border-dashed" data-testid="card-analytics-placeholder">
            <CardHeader className="text-center">
              ...
              <CardTitle className="font-display text-xl">Analytics Coming Soon</CardTitle>
              <CardDescription>
                Revenue reports, delivery metrics, customer insights, and business trends.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Daily, weekly, monthly revenue</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Volume and efficiency stats</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Growth and retention data</p>
                  </div>
                </div>
              </div>
            </CardContent>
