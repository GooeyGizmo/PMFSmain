...
export const subscriptionTiers: SubscriptionTier[] = [
  ...
  },
  {
    ...
    fuelDiscount: 0.02,
    maxVehicles: 2,
    features: ['Reduced delivery fee', '2¢/L fuel discount', 'Priority scheduling', 'SMS notifications'],
  },
  {
    id: '3',
    name: 'Household',
    ...
    fuelDiscount: 0.04,
    maxVehicles: 5,
    features: ['FREE delivery', '4¢/L fuel discount', 'Up to 5 vehicles', 'Priority support', 'Recurring schedules'],
  },
  {
    id: '4',
    ...
    fuelDiscount: 0.06,
    maxVehicles: 15,
    features: ['FREE delivery', '6¢/L fuel discount', 'Up to 15 vehicles', 'Farm & fleet ready', 'Dedicated account manager', 'Bulk ordering'],
  },
];
...
export const faqs = [
  ...
  },
  {
    ...
    answer: 'We currently serve the greater Regina, Saskatoon, and surrounding prairie communities. Check our coverage map or enter your address during booking to confirm service availability.',
  },
  {
